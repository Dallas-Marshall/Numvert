...
public class Converter {
    private static final String[][] lengthConversionTable = {
     ...
     * @return Converted measurement as a double value.
     */
    public static double convertLength(String fromUnits, double fromMeasurement, String toUnits) {
        int fromSelectionIndex = indexes.indexOf(fromUnits);
        int toSelectionIndex = indexes.indexOf(toUnits);
        double conversionFactor = Double.parseDouble(lengthConversionTable[fromSelectionIndex][toSelectionIndex]);
